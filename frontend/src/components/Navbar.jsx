            ...
            {user ? (
              <>
                ...
                {user.role === 'customer' && (
                  <Link
                    to="/bookings"
                    className="hidden sm:flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-slate-300 hover:text-white transition-colors duration-200"
                  >
                ...
                {user.role === 'admin' && (
                  <Link
                    to="/admin/dashboard"
                    className="hidden sm:flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-amber-400 hover:text-amber-300 transition-colors duration-200"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
